...
// The most important fix in this file: Radix's Popper positioning needs a
// real DOM ref to the trigger to anchor the menu correctly. Without
// forwardRef here, the trigger (commonly used as
// <DropdownMenuTrigger asChild><Button>...</Button></DropdownMenuTrigger>)
// silently fails to receive that ref under React 18, and the menu can open
// mispositioned.
