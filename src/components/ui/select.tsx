...
>((props, ref) => {
  // SelectPrimitive.Root does not render a DOM node itself, so there is no
  // element to attach ref to - forwardRef exists here only so <Select> is a
  // consistent, ref-safe component like its siblings in this file.
  void ref
